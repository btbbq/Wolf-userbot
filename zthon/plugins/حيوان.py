...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝗪𝗢𝗟𝗙  𓆪 </b> - @INNV8  "
...
async def who(event):
    ...
    if replied_user.id == 6766128426 or replied_user.id == 6969088145 or replied_user.id == 6766128426:
