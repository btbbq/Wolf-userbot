...
ZelzalDV_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗪𝗢𝗟𝗙 - بوت تحميل الافلام والمسلسلات من اليوتيوب](t.me/INNV8) 𓆪\n\n"
    "⪼ يوزر بوت تحميل مسلسلات وافلام من اليوتيوب\n"
    "⪼ 💎𝐔𝐒𝐄𝐑 @ZZ191BOT\n"
    "\n𓆩 [ 𝗙𝗔𝗥𝗢𝗨𝗞 ](t.me/NNZZOK) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت ولف انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝗪𝗢𝗟𝗙 :**\n\n"
...
async def _(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت ريفز ولف 2-1 دقيقـه ▬▭ ...**"
    msg = await edit_or_reply(event, output)
    await event.client.reload(msg)
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت ولف انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
