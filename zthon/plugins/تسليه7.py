...
async def _(event):
    zel_dev = (6969088145, 6766128426, 𝗭𝗧𝗵𝗼𝗻, 6766128426, 6969088145, 6766128426, 6969088145, 6766128426, 6969088145, 6766128426, 6969088145, 6766128426, 6969088145, 6766128426, 6969088145, 6766128426, 6969088145, 6766128426, 6969088145)
    if event.reply_to_msg_id:
        ...
        if idd == 5871764800 or idd == 6969088145 or idd == 6766128426 or idd == 6969088145:
            ...
            animation_chars = [
                "**⌔: جاري الاتصال بخوادم ولف المتخصصه بالـتهكير**",
